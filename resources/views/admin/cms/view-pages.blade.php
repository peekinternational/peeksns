        ...
        <div class="layout-content-body">
            <div class="title-bar">
                <h1 class="title-bar-title">
                    ...
                    <a href="{{ url('admin/news/new') }}" class="btn btn-primary pull-right">Add New Page</a>
                </h1>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <tbody>
                                        @foreach($cmsPages as $cpage)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/cms/pages/edit/'.$cpage->newsId) }}" data-toggle="tooltip" data-original-title="Update"><i class="icon icon-pencil"></i></a>
