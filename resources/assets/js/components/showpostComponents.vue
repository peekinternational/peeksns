    ...
    <div class="row" style="margin-bottom: 81px;margin-top: 81px;">  
      ...
      <div class="col-md-6 col-md-offset-1" >
        <div class="left-sideBar">
          <div class="post-img"><img :src="'http://203.99.61.173/demos/peeksns/public/images/'+showdata.image" style="width:100%"></div>
        </div>
      </div>
       <div class="col-md-4">	
          <div class="right-sideBar">	
            ...
            <div class="col-md-1 col-xs-2 user-newsfeed-img">
              <img :src="'http://203.99.61.173/demos/peeksns/public/profile-photos/'+showdata.profilePhoto">
       ...
       <div class="jd-share-btn" style="">
             ...
             <p style="font-size: 12px;" @click="percmtreply(cmt.cmt_id)"> Reply - {{cmt.created_at}} </p>
              ...
              <img :src="'http://203.99.61.173/demos/peeksns/public/profile-photos/profile-logo.png'" style="border-radius: 50%">
               ...
               <div class="col-sm-10" style="padding-left: 0;margin-top: 9px;">
           ...
           <div class="col-md-10" style="padding-left: 0;margin-top: 0px;"> <input type="text"  class="form-control" name="cmt_box" placeholder="Write reply" v-model="replytext" @keydown.enter="Perreplycmt(cmt.cmt_id,cmt.pst_id)">
            </div>
            </div>
              </div><!-- /col-sm-5 -->
              </div>
            ...
            <div class="col-md-10" style="padding-left: 0;margin-top: 3px;"> <input type="text"  class="form-control" name="cmt_box"  v-model="cmttext" placeholder="Write Comment" @keydown.enter="addcmtper(showdata.post_id)">
            </div>
            </div>
            ...
            <div class="col-md-10" style="padding-left: 0;margin-top: 3px;"> <input type="text"  class="form-control" name="cmt_box" placeholder="Write Comment" v-model="editData.comt_text" @keydown.enter="perupdatecmt(editData.cmt_id)">
            </div>
            </div>
          </div>
          </div>
    ...
    methods:{
      favorite(id) {
         this.isFavorited=true;
               axios.post('http://203.99.61.173/demos/peeksns/public/account/perlike/',{
                 'post_ID':id
               })
              .then(response => {
            ...
            unFavorite(id) {
              this.isFavorited=false;
               axios.post('http://203.99.61.173/demos/peeksns/public/account/perdislike/'+id)
                    .then(response => {
                      this.showdata=responce.data[0]
             ...
             addcmtper(id){
               ...
               axios.post('http://203.99.61.173/demos/peeksns/public/account/addcmtper',{
         ...
         editbox(id){
              axios.get('http://203.99.61.173/demos/peeksns/public/account/pereditcmt/'+id)
              .then((responce) => {
        ...
        Perreplycmt(id,p_id){
         ...
         shows(){
              ...
              getperdata(){
                    axios.get('http://203.99.61.173/demos/peeksns/public/account/post/'+this.post_id)
                  .then((responce) => {
                    this.showdata=responce.data[0];
                  })
                  .catch((error) => console.log(error));
